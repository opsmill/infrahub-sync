"""Operator-reference contract for the deployed managed storage profile."""
...
def test_managed_storage_operator_references_state_the_complete_deployed_contract(name: str) -> None:
    """Every managed-storage reference names one PostgreSQL/S3 deployment shape."""
...
def test_durable_records_reference_limits_the_local_projection_to_the_injected_seam() -> None:
    """The local projection is not presented as a deployed managed profile."""
