...
@pytest.mark.parametrize("declared", ["2.0.1", "3.0.0", "v3.0.0a3", "3.0.0a2", " 3.0.0a3", ""])
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("infrahub_sync-3.0.0a3-py3-none-any.whl",),
        ("infrahub-sync-3.0.0a3-py3-none-any.whl", "infrahub_sync-3.0.0a3.tar.gz"),
    ],
)
def test_the_dry_run_refuses_a_distribution_the_identity_does_not_name(
    ...
    with pytest.raises(release.ReleaseTaskError, match=r"not the 3\.0\.0a3 distributions"):
