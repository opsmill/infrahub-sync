...
These skills are unreleased source content. Check your candidate's release
notes for whether they are included. They ship only in a later Compose bundle
built from a revision that contains these files.
