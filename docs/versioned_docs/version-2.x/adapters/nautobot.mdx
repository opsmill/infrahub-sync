...
<Tabs>
  <TabItem value="Nautobot v1">
  <ReferenceLink title="config.yml" url="https://github.com/opsmill/infrahub-sync/blob/2b073acbc16f8b0b61ca57ef86402b20e5b99752/examples/nautobot-v1_to_infrahub/config.yml" openInNewTab />
  </TabItem>
  <TabItem value="Nautobot v2">
  <ReferenceLink title="config.yml" url="https://github.com/opsmill/infrahub-sync/blob/2b073acbc16f8b0b61ca57ef86402b20e5b99752/examples/nautobot-v2_to_infrahub/config.yml" openInNewTab />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  ```bash
  curl https://raw.githubusercontent.com/opsmill/infrahub-sync/2b073acbc16f8b0b61ca57ef86402b20e5b99752/examples/nautobot-v1_to_infrahub/config.yml > config.yml
  ```
  ...
  ```bash
  curl https://raw.githubusercontent.com/opsmill/infrahub-sync/2b073acbc16f8b0b61ca57ef86402b20e5b99752/examples/nautobot-v2_to_infrahub/config.yml > config.yml
  ```
