...
<ReferenceLink title="Source config.yml" url="https://github.com/opsmill/infrahub-sync/blob/2b073acbc16f8b0b61ca57ef86402b20e5b99752/examples/peering-manager_to_infrahub/config.yml" openInNewTab />
<ReferenceLink title="Destination config.yml" url="https://github.com/opsmill/infrahub-sync/blob/2b073acbc16f8b0b61ca57ef86402b20e5b99752/examples/infrahub_to_peering-manager/config.yml" openInNewTab />

To download those examples `config.yml`

```bash title="peering-manager to infrahub"
curl https://raw.githubusercontent.com/opsmill/infrahub-sync/2b073acbc16f8b0b61ca57ef86402b20e5b99752/examples/peering-manager_to_infrahub/config.yml > config.yml
```

```bash title="infrahub to peering-manager"
curl https://raw.githubusercontent.com/opsmill/infrahub-sync/2b073acbc16f8b0b61ca57ef86402b20e5b99752/examples/infrahub_to_peering-manager/config.yml > config.yml
```
