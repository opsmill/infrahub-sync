...
<ReferenceLink title="config.yml" url="https://github.com/opsmill/infrahub-sync/blob/2b073acbc16f8b0b61ca57ef86402b20e5b99752/examples/netbox_to_infrahub/config.yml" openInNewTab />

To download the example `config.yml`

```bash
curl https://raw.githubusercontent.com/opsmill/infrahub-sync/2b073acbc16f8b0b61ca57ef86402b20e5b99752/examples/netbox_to_infrahub/config.yml > config.yml
```
