...
1. **Prerequisites**
    ...
    - Python 3.10–3.13, for the CLI client
    - Credentials and network access for the source and destination systems
2. **Install Infrahub Sync.** See [Install Infrahub Sync](./installation.mdx): bring up the Compose deployment, then install the `infrahub-sync` CLI as its client.
