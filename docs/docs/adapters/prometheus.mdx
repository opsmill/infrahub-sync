...
This adapter uses the [prometheus-client](https://pypi.org/project/prometheus-client) library for parsing Prometheus exposition format.
...
- Provide default values for optional lookups
...
- Test queries in Prometheus UI before using in config
