...
For a gradual migration, plan data ownership and workflow changes alongside the import.
For the first connection and preview with existing systems, follow the
[NetBox](./tutorials/netbox-to-existing-infrahub.mdx) or
[Nautobot](./tutorials/nautobot-to-existing-infrahub.mdx) tutorial.
