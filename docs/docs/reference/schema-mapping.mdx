...
```shell
infrahub-sync diff --name <project> --directory <dir> --from-plan <run-id> --detail
```
...
[Reviewing and applying a cached plan](../running-a-sync#reviewing-and-applying-a-cached-plan).
