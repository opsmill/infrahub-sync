...
HTTP provides no transport encryption for bearer credentials. Use HTTP only when the service
connection stays inside a network you trust; use HTTPS across networks you do not trust.
