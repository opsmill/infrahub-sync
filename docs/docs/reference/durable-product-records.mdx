...
The local SQLite/filesystem projection is an internal test seam. It is not a managed
deployment option or a public CLI/Python execution mode. In-process service and store tests
