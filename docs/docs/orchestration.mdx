...
- Install the `service` extra when an automation client needs a Sync-owned authenticated
...
Use the Sync API for the supported worker-backed run lifecycle. For schedules, retry
