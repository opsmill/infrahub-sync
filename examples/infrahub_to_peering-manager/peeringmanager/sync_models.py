...
class InfraAutonomousSystem(_ModelBaseClass):
    ...
    _identifiers = ("asn",)
    _attributes = ("ipv4_max_prefixes", "ipv6_max_prefixes", "affiliated", "name", "irr_as_set", "description")
...
class InfraIXPConnection(_ModelBaseClass):
    ...
    _identifiers = ("name",)
    _attributes = ("internet_exchange_point", "peeringdb_netixlan", "vlan", "description", "status")
    name: str
