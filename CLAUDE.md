...
`dev/specs/001-plan-artifact-saved-apply/plan.md`
...
- `dev/specs/001-plan-artifact-saved-apply/spec.md` — requirements (FR-001…FR-030), success
  criteria (SC-001…SC-018), and the index of the settled decisions AD001–AD091, whose rules are
  tabled in `tasks.md`
...
- `dev/specs/001-plan-artifact-saved-apply/contracts/` — the plan artifact format, the reader
  and verifier API, the CLI review mode, and the destination write surface
- `dev/specs/001-plan-artifact-saved-apply/quickstart.md` — how to validate locally and against
  a live destination (`-m integration`)
<!-- SPECKIT END -->
