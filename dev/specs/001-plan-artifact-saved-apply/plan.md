...
| SC-002 | **Passing** — `test_re_applying_an_identical_plan_converges` |
| SC-003 | **Passing** — `test_the_write_class_conformance_matrix` for all three write classes |
